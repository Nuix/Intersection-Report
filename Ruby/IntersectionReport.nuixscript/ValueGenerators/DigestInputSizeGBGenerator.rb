$value_generators << ScriptedColumnValueGenerator.new("Digest Input Size (GB)","Digest Input Size") do |nuix_case,query|
	...
	next FormatUtility.bytesToGigaBytes(digest_input_size_bytes,3)
end